#1.What were the first four locations hooked up to the Internet (ARPANET)? The first four locations connected to ARPANET, the precursor to the Internet, were:
